...
export default function SchoolProfile() {
  ...
  const [profileImage, setProfileImage] = useState('https://picsum.photos/seed/school-logo/200/200');
      ...
      <div className="bg-white p-8 sm:p-10 rounded-[40px] border border-slate-100 shadow-sm">
        <div className="flex flex-col sm:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center sm:text-left">
            <h1 className="text-3xl font-bold text-slate-900">{formData.schoolName}</h1>
            <p className="text-lg font-bold text-brand mb-4">Administrator: {formData.firstName} {formData.lastName}</p>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm font-medium text-slate-500">Update school details and administrator info</p>
              </div>
            </div>
                ...
                <div className="p-8 space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" defaultValue={formData.schoolName} className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl outline-none focus:ring-2 focus:ring-brand/20 font-medium text-slate-700" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700 ml-1">Administrator First Name</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700 ml-1">Administrator Last Name</label>
              ...
              >
                <div className="p-8 space-y-4">
                  {[
                    ...
                    { id: 'admissions', label: 'Admission Alerts', desc: 'Notifications for new student applications' },
