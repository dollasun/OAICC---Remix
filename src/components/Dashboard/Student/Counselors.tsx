            ...
            >
              <div className="p-8 sm:p-10">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <button onClick={() => setIsBookingModalOpen(false)} className="p-2 text-slate-400 hover:bg-slate-50 rounded-lg transition-all">
                    <X className="w-6 h-6" />
                  </button>
                </div>
                ...
                {bookingStep === 1 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {counselors.map(c => (
                      <button
                        ...
                        className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100 hover:border-brand hover:bg-brand/5 transition-all text-left group"
                      >
                  ...
                  <form onSubmit={handleConfirmBooking} className="space-y-6">
                    ...
                    <div className="flex gap-4 pt-4">
                      ...
                      <button 
                        type="submit"
                        className="flex-[2] py-4 bg-brand text-white font-bold rounded-xl shadow-sm shadow-brand/5 hover:scale-105 transition-all"
                      >
                        Confirm Booking
                      </button>
                    </div>
            ...
            <div className="p-8 flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {counselor.expertise.map((exp) => (
                  <span key={exp} className="px-3 py-1.5 bg-brand/5 text-brand rounded-lg text-[10px] font-bold uppercase tracking-wider">
                    {exp}
                  </span>
                ))}
              </div>
