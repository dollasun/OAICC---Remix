    ...
    <div className="space-y-8">
      ...
      <div className="bg-slate-900 rounded-[40px] p-8 sm:p-12 text-white relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Mastering the Art of Interviewing</h2>
          <p className="text-white/70 text-lg font-medium mb-8">
            Join our exclusive session with HR directors from Fortune 500 companies and learn how to ace your next interview.
          </p>
