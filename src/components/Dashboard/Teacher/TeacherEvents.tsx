...
const events = [
  {
    ...
    type: 'Virtual',
    category: 'Workshop',
    image: 'https://picsum.photos/seed/teacher-event/800/400',
    attendees: 1240,
    isRegistered: true,
    description: 'Explore innovative teaching methods and digital tools that can transform your classroom and engage students more effectively.'
  },
  {
    id: 2,
    title: 'Career Guidance for Educators',
    date: 'Oct 18, 2024',
    time: '2:00 PM - 3:30 PM',
    type: 'Online Webinar',
    category: 'Webinar',
    image: 'https://picsum.photos/seed/teacher-ai/800/400',
    attendees: 450,
    isRegistered: false,
    description: 'Learn how to better guide your students through their career exploration journey using the OAICC platform and other resources.'
  },
  {
    id: 3,
    title: 'Teacher Networking Night',
    date: 'Oct 22, 2024',
    time: '5:00 PM - 7:00 PM',
    type: 'In-Person (Lagos)',
    category: 'Networking',
    image: 'https://picsum.photos/seed/teacher-design/800/400',
    attendees: 85,
    isRegistered: false,
    description: 'Connect with fellow educators from across the region to share experiences, challenges, and best practices in modern education.'
  },
  {
    id: 4,
    title: 'STEM Education Summit',
    date: 'Nov 05, 2024',
    time: '9:00 AM - 5:00 PM',
    type: 'In-Person (Abuja)',
    category: 'Summit',
    image: 'https://picsum.photos/seed/teacher-finance/800/400',
    attendees: 2000,
    isRegistered: false,
    description: 'A comprehensive summit focusing on the future of STEM education and how to prepare students for technical careers.'
  }
];
    ...
    <div className="space-y-8">
      ...
      <div className="bg-slate-900 rounded-[40px] p-8 sm:p-12 text-white relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Empowering the Next Generation</h2>
          <p className="text-white/70 text-lg font-medium mb-8">
            Join our exclusive session with global education leaders and learn how to inspire and empower your students for the future.
          </p>
